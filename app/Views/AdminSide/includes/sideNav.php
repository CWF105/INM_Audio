...
<aside>
    <nav class="sidenav">
        <div class="logo-title">
            <img src="<?= base_url('admin/img/logo.png') ?>" alt="logo">
            <h2>Admin Panel</h2>
        </div>
        <ul>
            <!-- account setting button -->
            <a href="<?= base_url('/admin/accountSetting') ?>" class="link" id="settings">
                <li>
            ...
            <!-- Dashboard button -->
            <a href="<?= base_url('/admin/dashboard') ?>" class="link" id="dashboard">
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-border-all" viewBox="0 0 16 16"><path d="M0 0h16v16H0zm1 1v6.5h6.5V1zm7.5 0v6.5H15V1zM15 8.5H8.5V15H15zM7.5 15V8.5H1V15z"/></svg>
                    <h3>Dashboard</h3>
                </li>
            </a>

            <!-- Transactions button -->
            <a href="<?= base_url('/admin/transactions') ?>" class="link" id="transactions">
                <li>
            ...
            <!-- Order/Shippings -->
            <a href="javascript:void(0)" onclick="toggleDropdown()" class="link" id="customers">
                <li>
            ...
            <!-- Gears button -->
            <a href="<?= base_url('/admin/gears') ?>" class="link" id="management">
                <li>
            ...
            <!-- Logout button-->
            <a href="<?= base_url('/admin/loggingOut') ?>" class="logout" id="logout">
                <li>
            ...
            <!-- Register admin or user accounts-->
            <a href="<?= base_url('/admin/registerA') ?>" class="link" id="register">
                <li>
...
<script src="<?= base_url('admin/js/sidenav.js') ?>"></script>
